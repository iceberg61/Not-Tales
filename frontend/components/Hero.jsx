...
const heroBackgrounds = [
  { src: "/images/hero-desktop.jpeg", visibility: "hidden md:block" },
  { src: "/images/hero-mobile.jpeg", visibility: "block md:hidden" },
];
      ...
      <div className="relative min-h-[620px] md:min-h-[700px] overflow-hidden pt-6 md:pt-0">
        {heroBackgrounds.map((bg) => (
          <Image
            ...
            fill
            priority
            className={`${bg.visibility} object-cover`}
          />
        ))}
          ...
          <div className="relative hidden md:block h-[520px]">
            ...
            {sideImages.map((img) => (
              <Image
                ...
                width={img.width}
                height={img.height}
                className={`${img.className} rounded-3xl object-cover shadow-2xl`}
              />
            ))}
          </div>
        </div>
